...
public class WirelessChargerScreen extends MachineScreen<WirelessChargerMenu> {
    private static final ResourceLocation BACKGROUND_TEXTURE = ExtraStuck.modid("textures/gui/wireless_charger.png");
    ...
    protected void renderTooltip(@Nonnull GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (x >= CHARGE_BAR_X && x <= CHARGE_BAR_X + CHARGE_BAR_WIDTH && y >= CHARGE_BAR_Y
            ...
            Component tooltip = Component.translatable(ESLangProvider.ENERGY_STORAGE_KEY,
                    ...
                    NumberFormat.getInstance().format(ConfigServer.CHARGER_FE_STORAGE.get()));
    ...
    protected void renderBg(@Nonnull GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        int charge_fill = getScaledValue(menu.getCharge(), ConfigServer.CHARGER_FE_STORAGE.get(), CHARGE_BAR_HEIGHT);
        ...
        int fuel_fill = getScaledValue(menu.getFuel(), ConfigServer.CHARGER_URANIUM_STORAGE.get(), FUEL_BAR_HEIGHT);
