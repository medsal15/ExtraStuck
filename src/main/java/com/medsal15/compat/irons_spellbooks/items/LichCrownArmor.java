...
public class LichCrownArmor extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public LichCrownArmor(Holder<ArmorMaterial> material, ArmorItem.Type slot, Properties properties) {
    ...
    public static class Model extends GeoModel<LichCrownArmor> {
        @Override
        public ResourceLocation getModelResource(LichCrownArmor animatable) {
            return ExtraStuck.modid("geo/lich_crown.geo.json");
        }

        @Override
        public ResourceLocation getTextureResource(LichCrownArmor animatable) {
            return ExtraStuck.modid("textures/models/armor/lich_crown.png");
        }

        @Override
        public ResourceLocation getAnimationResource(LichCrownArmor animatable) {
