...
public class NetherLichCrownArmor extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public NetherLichCrownArmor(Holder<ArmorMaterial> material, ArmorItem.Type slot, Properties properties) {
    ...
    public static class Model extends GeoModel<NetherLichCrownArmor> {
        @Override
        public ResourceLocation getModelResource(NetherLichCrownArmor animatable) {
            return ExtraStuck.modid("geo/lich_crown.geo.json");
        }

        @Override
        public ResourceLocation getTextureResource(NetherLichCrownArmor animatable) {
            return ExtraStuck.modid("textures/models/armor/nether_lich_crown.png");
        }

        @Override
        public ResourceLocation getAnimationResource(NetherLichCrownArmor animatable) {
