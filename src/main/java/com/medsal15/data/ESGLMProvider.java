...
import com.medsal15.loot.modifiers.BoondollarLootModifier;
...
public class ESGLMProvider extends GlobalLootModifierProvider {
        ...
        protected void start() {
                ...
                add("medium_heat", new ESLandLootModifier(
                                new LootItemCondition[] { LootTableIdCondition
                                                .builder(Minestuck.id("chests/medium_basic")).build() },
                                                ...
                                                new LootItemCondition[] {
                                                                LootTableIdCondition
                                                                                .builder(Minestuck.id(
                                                                                                "chests/medium_basic"))
                                                                                .build() },
                                                TableSubProvider.INJECT_PUSB.location(), Optional.empty(),
                                                Optional.empty()),
                                List.of(new ModLoadedCondition("irons_spellbooks")));

                add("boondollar_mining", new BoondollarLootModifier(
                                new LootItemCondition[] { new CanItemPerformAbility(ESItemTypes.BOONDOLLAR_MINING) },
                                0.5F));
        }
}
