...
public final class ESItemModelProvider extends ItemModelProvider {
    ...
    private void registerShields() {
        ...
        modelShieldHandle(ESItems.ETERNAL_SHIELD, "capitashield_handle");
    }
    ...
    private void registerArmors() {
        ...
        basicItem(ESItems.SALESWOMAN_GLASSES.get());
        basicItem(ESItems.GRIST_VIEWERS.get());
        ...
        basicItem(ESItems.CACTUS_HELMET.get());
    ...
    private void registerModus() {
        ...
        basicItem(ESItems.FURNACE_MODUS_CARD.get());
        basicItem(ESItems.COMPACT_MODUS_CARD.get());
        basicItem(ESItems.CRAFTING_MODUS_CARD.get());
    ...
    private void registerTools() {
        ...
        basicItem(ESItems.METAL_RING.get());
        ...
        basicItem(ESItems.THERMAL_RING.get());
        // Visions
