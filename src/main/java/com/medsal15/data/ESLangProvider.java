...
public final class ESLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addItem(ISSESItems.CASSETTE_WHISPERS_OF_ICE, "Cassette");
    ...
    private void addWeapons() {
        ...
        // Knives
        addItem(ISSESItems.AMETHYST_BACKSTABBER, "Amethyst Backstabber");
        addItemTooltip(ISSESItems.AMETHYST_BACKSTABBER, "Intruder Alert! A Dersite Spy is in the base!");
        // Spoons
        ...
        // Staves
        addItem(ISSESItems.CURSED_CAT_STAFF, "Cursed Cat Staff");
        addItemTooltip(ISSESItems.CURSED_CAT_STAFF, "You can hear strange whispers when holding it...");
        addItem(ISSESItems.BLESSED_CAT_STAFF, "Blessed Cat Staff");
        addItemTooltip(ISSESItems.BLESSED_CAT_STAFF, "A powerful staff for a dangerous wanderer");
        addItem(ISSESItems.BRANCH_OF_YGGDRASIL, "Branch of Yggdrasil");
        addItemTooltip(ISSESItems.BRANCH_OF_YGGDRASIL, "Snapped straight off the World Tree");
        addItem(ISSESItems.STAFF_OF_YGGDRASIL, "Staff of Yggdrasil");
        addItem(ISSESItems.PROSPITIAN_WAND, "Prospitian Wand");
        addItemTooltip(ISSESItems.PROSPITIAN_WAND, "Big wand commonly used by Prospitians for magic");
        addItem(ISSESItems.DERSITE_WAND, "Dersite Wand");
        addItemTooltip(ISSESItems.DERSITE_WAND, "Years of misuse by Dersites have bent it");
        // Spellbooks
        addItem(ISSESItems.GRIMOIRE, "Grimoire for Manipulating the Physically Dubious");
        addItemTooltip(ISSESItems.GRIMOIRE, "The volume number is unreadable");
        addItem(ISSESItems.GEMINI_SPELLBOOK_RED, "Gemini Spell Book");
        addItem(ISSESItems.GEMINI_SPELLBOOK_BLUE, "Gemini Spell Book");
        addItem(ISSESItems.MAGE_GUY, "Mage Guy");
        addItemTooltip(ISSESItems.MAGE_GUY, "Instead of magic tricks, this one contains spells!");
        addItem(ISSESItems.PERFECTLY_UNIQUE_SPELLBOOK, "Perfectly Unique Spell Book");
        addItem(ISSESItems.SBURBDB, "SburbDB");
        addItemTooltip(ISSESItems.SBURBDB, "Database of everything in Sburb (book edition)");
    ...
    private void addArmors() {
        ...
        addItem(ISSESItems.LICH_CROWN, "Lich Crown");
        addItem(ISSESItems.NETHER_LICH_CROWN, "Crown of the Netherlich");

        addItem(ISSESItems.COSMIC_PLAGUE_HELMET, "Cosmic Plague Helmet");
        addItem(ISSESItems.COSMIC_PLAGUE_CHESTPLATE, "Cosmic Plague Chestplate");
        addItem(ISSESItems.COSMIC_PLAGUE_LEGGINGS, "Cosmic Plague Leggings");
        addItem(ISSESItems.COSMIC_PLAGUE_BOOTS, "Cosmic Plague Boots");
    ...
    private void addTools() {
        ...
        addItem(ESItems.METAL_RING, "Metal Ring");
        addItem(ESItems.HEAVY_METAL_RING, "Heavy Metal Ring");
        ...
        addItem(ESItems.THERMAL_RING, "Thermal Ring");
        // Visions
        ...
        // Grist Filter
        addItem(CreateESItems.GRIST_FILTER, "Grist Filter");
    ...
    private void addTags() {
        ...
        add(ESTags.Items.TOOLBOX_FORBIDDEN, "Cannot be put in toolboxes");
