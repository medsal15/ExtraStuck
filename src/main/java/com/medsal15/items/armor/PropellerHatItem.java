...
public class PropellerHatItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public PropellerHatItem(Holder<ArmorMaterial> material, ArmorItem.Type slot, Properties properties) {
