...
import com.medsal15.client.model.armor.SalesmanGogglesModel;
...
public class SalesmanGogglesItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public SalesmanGogglesItem(Holder<ArmorMaterial> material, ArmorItem.Type slot, Properties properties) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> @Nullable HumanoidModel<?> getGeoArmorRenderer(@Nullable T livingEntity,
                ...
                if (this.renderer == null)
                    renderer = new GeoArmorRenderer<>(new SalesmanGogglesModel());
                return renderer;
            }
        });
    }
